...
public class Network {
    ...
    public static void init() {
        INSTANCE.registerMessage(0, StructureRenderPacket.class, StructureRenderPacket::write, StructureRenderPacket::new, StructureRenderPacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
